...
public:
    vector<vector<int>> generate(int numRows) {
       ...
       // return the matrix
        ...
        // then we apply the forumula row C col = row!/col!*(row-col)!
        ...
        // so we can always multiply the row col number of times
        ...
        // 1 4 6 4 1
        // 1 4/1 4*3/    4*3*2/1*2*3 1
        // every next element is multiplied by the previous element if you look carefully
        // 1. create a variable called ans = 1;
        // 2. start a loop from col = 0 to the col = number of rows/columns both are same
        // 3. inside the loop 
